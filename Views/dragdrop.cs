...
namespace GongSolutions . Wpf . DragDrop
{
        ...
        public class DefaultDropHandler : IDropTarget
        {
                ...
                /// <param name="applyTemplate">if set to <c>true then for all items the ApplyTemplate will be invoked.
                /// <param name="focusVisualTarget">if set to <c>true the visual target will be focused.
                /// <exception cref="System.ArgumentNullException"><paramref name="dropInfo" /> is <see langword="null">
                /// <exception cref="System.ArgumentNullException"><paramref name="dropInfo" /> is <see langword="null">
